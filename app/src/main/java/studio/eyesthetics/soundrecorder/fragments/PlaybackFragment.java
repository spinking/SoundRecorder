...
public class PlaybackFragment extends DialogFragment {
    ...
    //stires wheter or not the mediaplayer is currently playing audio
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        seconds = TimeUnit.MICROSECONDS.toSeconds(itemDuration) - TimeUnit.MINUTES.toSeconds(minutes);
    }
        ...
        mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if(mMediaPlayer != null) {
                    ...
                    long minutes = TimeUnit.MILLISECONDS.toMinutes(mMediaPlayer.getCurrentPosition());
                    long seconds = TimeUnit.MILLISECONDS.toSeconds(mMediaPlayer.getCurrentPosition()) - TimeUnit.MINUTES.toSeconds(minutes);
                    mCurrentProgressTextView.setText(String.format("%02d:%02s", minutes, seconds));
                    updateSeekBar();
                }
            }
        });
